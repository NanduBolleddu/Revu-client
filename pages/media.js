      ...
      <div className="pt-12 px-8 pb-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-2 p-1 bg-white/[0.04] backdrop-blur-2xl rounded-2xl border border-white/15 shadow-md">
                  ...
                  <span className="relative inline-block">
                    {type === "all"
                      ...
                      : type === "image"
                        ...
                        : "VIDEOS"}
                    <span
                      className={`absolute bottom-[-4px] left-1/2 w-0 h-[2px] bg-gradient-to-r from-blue-400 to-purple-500 transition-all duration-300 ease-out transform -translate-x-1/2 ${
          ...
          >
            ...
            <div className="p-8">
              <form onSubmit={handleUpload} className="space-y-6">
                ...
                {uploadMessage && (
                  <div
                    className={`p-4 rounded-xl font-semibold text-center ${uploadMessage.includes("✅") ? "bg-green-500/20 text-green-400 border border-green-500/30" : "bg-red-500/20 text-red-400 border border-red-500/30"}`}
                  >
                    {uploadMessage}
                  </div>
                )}
